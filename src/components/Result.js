  ...
  render() {
    ...
    return (
      <div className="pollview-card">
        ...
        {loggedInUserSelectedOption===optionOneText?<p style={{width:'500px'}}>{`YOU CHOOSE Option A : ${optionOneText}`}</p>:<p>{`Option A : ${optionOneText}`}</p>}
          ...
          <ProgressBar
            ...
            className="bar"
          />
          {loggedInUserSelectedOption===optionTwoText?<p style={{width:'500px'}}>{`YOU CHOOSE Option B : ${optionTwoText}`}</p>:<p>{`Option B : ${optionTwoText}`}</p>}
